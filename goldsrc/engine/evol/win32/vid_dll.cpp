...
HINSTANCE	reflib_library;		// Handle to render DLL 
...
void VID_CheckChanges ()
{
	...
	while (vid_ref->modified)
	{
		...
		*/
		...
		{
			if ( Q_strcmp (vid_ref->string, "soft") == 0 )
...
#if 0
	{
		cvar_t gl_driver = { "gl_driver", "opengl32", 0 };
		cvar_t gl_mode = { "gl_mode", "3", 0 };
		
		Cvar_Register(&gl_driver);
